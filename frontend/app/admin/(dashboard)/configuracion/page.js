            ...
            <div style={{ display: "flex", flexDirection: "column", gap: isMobile ? 14 : 18 }}>
              ...
              <div className="alma-card" style={isMobile ? cardPaddingMobile : cardPaddingDesktop}>
                <div style={{ marginBottom: 16 }}>
                  ...
                  <p style={{ margin: 0, fontSize: 13, color: "#A89A87" }}>Define cuántas reservas simultáneas admite cada cabina.</p>
                </div>
                <div style={{ display: "grid", gap: 9 }}>
                  {rooms.filter((room) => room.active !== false).map((room) => (
                    <div key={room.id} style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) 74px", gap: 10, alignItems: "center", padding: "9px 0", borderBottom: "1px solid rgba(168,154,135,0.22)" }}>
